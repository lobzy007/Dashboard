  ...
  return (
    <div className="dark:bg-[#212121]">
      ...
      <nav className="w-100 flex justify-between items-center border-b-2 p-3 mb-6 px-5 dark:bg-[#212121] dark:text-white">
        ...
        <Link className="bg-gradient-to-r from-violet-600 to-indigo-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" to={"/login"}>Login</Link>
      </nav>
      ...
      <div className="showcase bg-gradient-to-r from-violet-600 to-indigo-600 text-white py-40 px-32 mb-20">
        <h1 className="text-5xl max-w-3xl mb-5">
          Join us in shaping the future, one click at a time.</h1>
          ...
          {data.data.map((d, i) => {
            return <div
              ...
              <div className="p-6 text-surface dark:text-white">
                ...
                <Link to={`/card/${i + 1}`}
                  type="button"
                  className="inline-block self-start justify-self-start rounded bg-gradient-to-r from-violet-600 to-indigo-600 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
      ...
      <div className="footer bg-gradient-to-r from-violet-600 to-indigo-600">
        <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center -mx-5 -my-2">
            ...
            <div className="px-5 py-2">
              <Link to={'/login'} className="text-base leading-6 text-white hover:underline">
                Login
              </Link>
            </div>
          </div>
